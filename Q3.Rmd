...
#Combine the data sets, seperate weekday from date and mutate the year 2018
combined <- control %>% 
  rbind(experiment) %>% 
...
<br>
f. Check what you learn about the difference in flow of traffic between control and experiment using a lineup plot.   
